...
function initCombo(_0x1a2b, _0x3c4d, _0x5e6f, _0x7a8b) {
  ...
  let _0x3333 = false;
  function _0x4444() {
    return typeof _0x5e6f === "function" ? _0x5e6f() : _0x5e6f;
  }
  function _0x5555(_0xaa11 = "") {
    _0x2222.innerHTML = "";
    const _0xbb22 = _0x4444();
    const _0xcc33 = _0x1111.hasAttribute("readonly")
      ? _0xbb22
      : _0xbb22.filter((_0xdd44) =>
          _0xdd44.toLowerCase().includes(_0xaa11.toLowerCase()),
        );
    if (_0xcc33.length === 0 && _0xaa11 !== "") {
      const _0xee55 = document.createElement("div");
      _0xee55.textContent = "Ничего не найдено";
      _0xee55.style.padding = "8px 12px";
      _0xee55.style.color = "#999";
      _0x2222.appendChild(_0xee55);
      return;
    }
    _0xcc33.forEach((_0xff66) => {
      const _0x11aa = document.createElement("div");
      _0x11aa.textContent = _0xff66;
      _0x11aa.className = "combo-option";
      _0x11aa.onclick = (_0x22bb) => {
        _0x22bb.stopPropagation();
        _0x1111.value = _0xff66;
        if (_0x7a8b) _0x7a8b(_0xff66);
        _0x3333 = false;
        _0x2222.classList.remove("active");
      };
  ...
  _0x1111.addEventListener("click", (_0x33cc) => {
    _0x33cc.stopPropagation();
    if (_0x1111.disabled) return;
    if (!_0x3333) {
      document
        .querySelectorAll(".combo-dropdown.active")
        .forEach((_0x44dd) => _0x44dd.classList.remove("active"));
      _0x3333 = true;
      _0x2222.classList.add("active");
      _0x5555(_0x1111.value);
    } else {
      _0x3333 = false;
      _0x2222.classList.remove("active");
    }
  ...
  _0x1111.addEventListener("input", (_0x55ee) => {
    ...
    _0x3333 = true;
    _0x2222.classList.add("active");
    _0x5555(_0x55ee.target.value);
  });
  document.addEventListener("click", (_0x66ff) => {
    if (
      !_0x1111.contains(_0x66ff.target) &&
      !_0x2222.contains(_0x66ff.target)
    ) {
      _0x3333 = false;
      _0x2222.classList.remove("active");
    }
...
function onDrag(_0x55ee) {
  ...
  const _0x66ff =
    _0x55ee.clientX !== undefined
      ? _0x55ee.clientX
      : _0x55ee.touches[0].clientX;
...
function dmyToIso(_0x44dd) {
  ...
  if (
    _0x88bb.getFullYear() !== _0x77aa ||
    _0x88bb.getMonth() !== _0x66ff - 1 ||
    _0x88bb.getDate() !== _0x55ee
  )
    return null;
  return (
    _0x77aa +
    "-" +
    String(_0x66ff).padStart(2, "0") +
    "-" +
    String(_0x55ee).padStart(2, "0")
  );
}
...
function validateAndUpdateDateRange() {
  ...
  _0x11aa.style.borderColor = "";
  _0x22bb.style.borderColor = "";
  _0x11aa.style.boxShadow = "";
  _0x22bb.style.boxShadow = "";
  const _0x55ee = (_0x88bb) => {
    ...
    return (
      _0x33dd.getFullYear() === _0x22cc &&
      _0x33dd.getMonth() === _0x11bb - 1 &&
      _0x33dd.getDate() === _0x99cc
    );
  };
...
applyBtn.addEventListener("click", () => {
  ...
  const rightsValue =
    rightsStatusEl && rightsStatusEl.getValue
      ? rightsStatusEl.getValue()
      : "any";
  const restrictionsValue =
    restrictionsStatusEl && restrictionsStatusEl.getValue
      ? restrictionsStatusEl.getValue()
      : "any";
...
resetBtn.addEventListener("click", () => {
  ...
  if (restrictionsStatusEl && restrictionsStatusEl.setValue)
    restrictionsStatusEl.setValue("any");
...
function initMultiSelect(containerSelector) {
  ...
  trigger.addEventListener("click", (e) => {
    ...
    document
      .querySelectorAll(".multiselect-window-dropdown, .multiselect-dropdown")
